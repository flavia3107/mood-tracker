...
export class February {
  ...
  chocolates = signal<Chocolate[]>([
    ...
    { id: 21, pts: "M280,325 h50 v50 h-50 Z", cx: 305, cy: 350, color: '#fff', rotate: -4 },
    ...
    { id: 18, pts: "M240,410 a30,15 0 1,1 60,0 a30,15 0 1,1 -60,0", cx: 270, cy: 410, color: '#fff', rotate: 5 },
