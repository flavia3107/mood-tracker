...
export class February {
  ...
  chocolates = signal<Chocolate[]>([
    // Row 1: Top Layer
    { id: 2, pts: "M90,155 a35,35 0 1,1 70,0 a35,35 0 1,1 -70,0", cx: 120, cy: 160, color: '#fff', rotate: 5 },
    { id: 28, pts: "M60,215 a12,12 0 1,1 50,0 a12,12 0 1,1 -50,0", cx: 85, cy: 220, color: '#fff', rotate: -10 },
    { id: 1, pts: "M145,170 a30,30 0 1,1 60,0 a30,30 0 1,1 -60,0", cx: 175, cy: 200, color: '#fff', rotate: 12 },
