...
export class February {
  ...
  chocolates = signal<Chocolate[]>([
    ...
    { id: 5, pts: "M380,220 h80 v50 h-80 Z", cx: 415, cy: 235, color: '#fff', rotate: -6 },
    ...
    { id: 10, pts: "M155,325 a35,18 0 1,1 90,0 a35,18 0 1,1 -90,0", cx: 200, cy: 330, color: '#fff', rotate: 5 },
    ...
    { id: 23, pts: "M115,350 h70 v50 h-70 Z", cx: 140, cy: 380, color: '#fff', rotate: 50 },
    ...
    { id: 17, pts: "M200,375 a30,15 0 1,1 70,0 a30,15 0 1,1 -70,0", cx: 235, cy: 375, color: '#fff', rotate: -10 },
    { id: 18, pts: "M245,420 a30,15 0 1,1 60,0 a30,15 0 1,1 -60,0", cx: 275, cy: 425, color: '#fff', rotate: 5 },
    ...
    // // Fillers
    { id: 20, pts: "M190,425 a25,25 0 1,1 50,0 a25,25 0 1,1 -50,0", cx: 210, cy: 430, color: '#fff', rotate: 15 },
