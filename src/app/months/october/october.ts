...
export class October {
  ...
  private _generateFacets() {
    const facetData = [
      ...
      { pts: "125,120 185,90 155,170", cx: 155, cy: 140 }, // (e.g., 110x -> 125x)
      { pts: "185,90 250,85 220,170", cx: 220, cy: 135 },
      { pts: "250,85 315,90 280,170", cx: 280, cy: 135 }, // (e.g., 320x -> 315x)
      { pts: "315,90 375,120 345,170", cx: 346, cy: 145 }, // (e.g., 390x -> 375x)
      ...
      { pts: "125,120 70,200 155,170", cx: 125, cy: 165 }, // Left side pulled in
      { pts: "375,120 430,200 345,170", cx: 375, cy: 165 }, // Right side pulled in
      ...
      { pts: "155,170 255,170 200,220", cx: 205, cy: 190 }, //16
      ...
      { pts: "155,250 79,312 165,350", cx: 130, cy: 310 }, // 24
